	 	...
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="firstName"><spring:message code="app.firstname"/></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="lastName"><spring:message code="app.lastname"/></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="ssoId"><spring:message code="app.ssoid"/></label>
					<div class="col-md-7">
						<c:choose>
							<c:when test="${edit}">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="password"><spring:message code="app.pwd"/></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="email"><spring:message code="app.email"/></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="userProfiles"><spring:message code="app.roles"/></label>
					<div class="col-md-7">
